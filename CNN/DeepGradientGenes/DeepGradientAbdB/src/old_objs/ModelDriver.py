...
class ModelDriverInterpretDeepGradient():
	...
	def init_interpret(self):
		self.interpretObj = InterpretDeepGradient(self.data['X_dev'], self.data['Y_dev'], self.data['X_train'], self.train_mean, self.train_std, self.params['model_loc'], self.params['tag'], self.params['minibatch_size'], self.params['threshold_sigmoid'])
