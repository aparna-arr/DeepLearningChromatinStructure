...
def main():
	...
	e1p_kthIdx = int(e1p_sortedDistances.shape[0] * 0.30)	
	...
	e2p_kthIdx = int(e2p_sortedDistances.shape[0] * 0.30)	
	...
	sp_kthIdx = int(sp_sortedDistances.shape[0] * 0.50)	
