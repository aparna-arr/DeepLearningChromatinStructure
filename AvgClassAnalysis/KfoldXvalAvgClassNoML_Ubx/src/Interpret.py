...
class Interpret:
	def __init__(self, X_test, Y_test, train_avg, train_std, model_loc, tag, architecture, threshold_sig = 0.5):
		self.X_test = X_test
		self.Y_test = Y_test
		...
		self.model = RestoreModel(self.architecture, self.tag, model_loc) 
