...
class ModelDriver():
	...
	def cross_validation(self):
		...
		dat = ReadData(self.params['X_train'], self.params['Y_train'], self.params['X_dev'], self.params['Y_dev'], False, True, normalize=False).load_data()
		testdat = ReadData(self.params['X_train'], self.params['Y_train'], self.params['X_test'], self.params['Y_test'], False, True, normalize=False).load_data()

		#dat = np.squeeze(dat)
		#testdat = np.squeeze(testdat)
