...
## This module contains the ReadData object and basic parsing / normalization functions

# Major object class that parses the raw data and 
# passes it to the Model object
class ReadData():	
