...
avgSimUbxDat<-as.numeric(read.delim(avgSimFileUbx, header=F, sep=",")[1,])
bestCNNUbxDat<-as.numeric(read.delim(bestCNNUbx, header=F, sep=",")[1,])
RFUbxDat<-as.numeric(read.delim(RFUbx, header=F, sep=",")[1,])
SVMUbxDat<-as.numeric(read.delim(SVMUbx, header=F, sep=",")[1,])
avgSimAbdADat<-as.numeric(read.delim(avgSimFileAbdA, header=F, sep=",")[1,])
bestCNNAbdADat<-as.numeric(read.delim(bestCNNAbdA, header=F, sep=",")[1,])
RFAbdADat<-as.numeric(read.delim(RFAbdA, header=F, sep=",")[1,])
SVMAbdADat<-as.numeric(read.delim(SVMAbdA, header=F, sep=",")[1,])
avgSimAbdBDat<-as.numeric(read.delim(avgSimFileAbdB, header=F, sep=",")[1,])
bestCNNAbdBDat<-as.numeric(read.delim(bestCNNAbdB, header=F, sep=",")[1,])
RFAbdBDat<-as.numeric(read.delim(RFAbdB, header=F, sep=",")[1,])
SVMAbdBDat<-as.numeric(read.delim(SVMAbdB, header=F, sep=",")[1,])
