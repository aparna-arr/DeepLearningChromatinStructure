...
## This model run script hijacks the ModelDriver object to allow a abdA trained model to be run on AbdB and Ubx output and make the plots 
...
minibatch_size = 32
specific_info = "INTERPRET_Other_genes"
